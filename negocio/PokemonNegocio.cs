...
namespace negocio
{
    public class PokemonNegocio
    {
        public List<Pokemon> listar()
        {
            ...
            try
            {
                ...
                while (lector.Read())
                {
                    ...
                    aux.Drescripcion = (string)lector["Descripcion"];
        ...
        public void agregar (Pokemon nuevo)
        {
            ...
            try
            {
                datos.setearConsulta("insert into POKEMONS(Numero, Nombre, Descripcion, Activo, IdTipo, IdDebilidad, UrlImagen) values(" + nuevo.Numero + ", '" + nuevo.Nombre + "', '" + nuevo.Drescripcion + "', 1, @idTipo, @idDebilidad, @urlImagen)");
        ...
        public void modificar (Pokemon poke)
        {
            ...
            try
            {
                ...
                datos.setearParametro("@desc", poke.Drescripcion);
        ...
        public List<Pokemon> filtrar(string campo, string criterio, string filtro)
        {
            ...
            try
            {
                ...
                while (datos.Lector.Read())
                {
                    ...
                    aux.Drescripcion = (string)datos.Lector["Descripcion"];
